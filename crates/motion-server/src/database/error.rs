...
use motion_sql::storage::StorageError;
...
impl From<motion_sql::parser::ParseError> for DatabaseError {
    fn from(e: motion_sql::parser::ParseError) -> Self {
        DatabaseError::ParseError(e.to_string())
    }
}

impl From<motion_sql::executor::ExecutionError> for DatabaseError {
    fn from(e: motion_sql::executor::ExecutionError) -> Self {
        DatabaseError::ExecutionError(e.to_string())
    }
}

impl From<motion_security::AuthError> for DatabaseError {
    fn from(e: motion_security::AuthError) -> Self {
