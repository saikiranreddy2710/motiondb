//! MySQL wire protocol handler for MotionDB.
//!
...
/// MotionDB MySQL protocol handler.
...
/// Maps MotionDB DataType to MySQL ColumnType.
...
/// Converts a MotionDB Value to a string for MySQL text protocol.
...
/// Writes a MotionDB statement result as MySQL wire protocol response.
