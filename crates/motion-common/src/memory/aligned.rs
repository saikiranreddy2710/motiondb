...
///
/// ```rust
/// use motion_common::memory::allocate_aligned;
///
...
///
/// ```rust
/// use motion_common::memory::AlignedBuffer;
///
...
///
/// ```rust
/// use motion_common::memory::AlignedVec;
///
...
///
/// ```rust
/// use motion_common::memory::CacheLineAligned;
