//! Core identifier types for MotionDB.
//!
...
///
/// Pages are the fundamental unit of storage in MotionDB. Each page is
...
///
/// ```rust
/// use motion_common::types::NodeId;
///
