//! # motion-txn
//!
//! Transaction manager for MotionDB.
//!
...
//!
//! ```ignore
//! use motion_txn::{TransactionManager, TransactionManagerConfig};
//! use motion_mvcc::{HybridLogicalClock, VersionStore, IsolationLevel};
//! use std::sync::Arc;
//! use bytes::Bytes;
//!
