//! # motion-client
//!
//! Client library for MotionDB.
//!
//! This crate provides a complete client library for connecting to and
//! interacting with MotionDB instances. It includes:
//!
//! - **Connection Management**: Establish and manage connections to MotionDB
...
//!
//! ```rust,ignore
//! use motion_client::{ConnectionPool, PoolConfig};
//!
//! #[tokio::main]
//! async fn main() -> Result<(), Box<dyn std::error::Error>> {
