//! Page header format.
//!
//! Every page in MotionDB starts with a 32-byte header containing metadata.
//!
...
use motion_common::types::{Lsn, PageId};
...
///
/// ```rust
/// use motion_storage::page::{PageHeader, PAGE_HEADER_SIZE};
