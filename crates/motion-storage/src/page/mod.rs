//! Page layout and disk format for MotionDB.
//!
//! This module implements the on-disk page format for MotionDB's storage engine.
...
pub const PAGE_SIZE: usize = motion_common::constants::DEFAULT_PAGE_SIZE;
...
pub const PAGE_MAGIC: u16 = motion_common::constants::PAGE_MAGIC;
